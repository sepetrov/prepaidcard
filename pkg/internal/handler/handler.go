...
// HanderFunc is an adapter to allow regular functions with the signature of
// Handle method of Handler interface to be wrapped and used as the Handler
// interface. This is useful when writing middleware.
type HanderFunc func(context.Context, http.ResponseWriter, *http.Request) error

// Handle implements Handler.
func (h HanderFunc) Handle(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
	return h(ctx, w, r)
}
